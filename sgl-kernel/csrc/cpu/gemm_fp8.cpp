...
#if defined(CPU_CAPABILITY_AVX512)
template <bool has_bias, int BLOCK_M, int BLOCK_N>
struct tinygemm_kernel_nn2<at::BFloat16, at::Float8_e4m3fn, float, has_bias, BLOCK_M, BLOCK_N> {
  static inline void apply(
      const at::BFloat16* __restrict__ A,
      const at::Float8_e4m3fn* __restrict__ B,
      float* __restrict__ C,
...
template <bool has_bias, int BLOCK_M, int BLOCK_N>
struct tinygemm_kernel_nn2<at::BFloat16, uint8_t, uint8_t, has_bias, BLOCK_M, BLOCK_N> {
  static inline void apply(
      const at::BFloat16* __restrict__ A,
      const uint8_t* __restrict__ B,
      float* __restrict__ C,
...
template <bool has_bias>
struct brgemm2<at::BFloat16, at::Float8_e4m3fn, float, has_bias> {
  static inline void apply(
      const at::BFloat16* __restrict__ A,
      const at::Float8_e4m3fn* __restrict__ B,
      float* __restrict__ C,
...
template <bool has_bias>
struct brgemm2<at::BFloat16, uint8_t, uint8_t, has_bias> {
  static inline void apply(
      const at::BFloat16* __restrict__ A,
      const uint8_t* __restrict__ B,
      float* __restrict__ C,
...
void tinygemm_kernel(
    ...
    bool do_unpack = true) {
  if (brg) {
    brgemm2<scalar_t, packed_t, param_t, has_bias>::apply(
        A, B, C, Btmp, bias, scale, M, N, K, lda, ldb, ldc, do_unpack);
    return;
  }
...
INSTANTIATE_TINYGEMM_TEMPLATE2(at::BFloat16, at::Float8_e4m3fn, float);
INSTANTIATE_TINYGEMM_TEMPLATE2(at::Half, at::Float8_e4m3fn, float);
INSTANTIATE_TINYGEMM_TEMPLATE2(at::BFloat16, uint8_t, uint8_t);
INSTANTIATE_TINYGEMM_TEMPLATE2(at::Half, uint8_t, uint8_t);
