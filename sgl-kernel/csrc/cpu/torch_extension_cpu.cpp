...
TORCH_LIBRARY_FRAGMENT(sgl_kernel, m) {
  ...
  m.def(
      ...
      "inplace, bool use_int8_w8a8, bool use_fp8_w8a16, bool use_int4_w4a16, bool use_int4_w4a8, Tensor? w1_scale, "
      "Tensor? w2_scale, "
      "Tensor? w1_zero, Tensor? w2_zero, int[]? block_size, Tensor? "
      "a1_scale, Tensor? a2_scale, Tensor? compensation_w1, Tensor? compensation_w2, bool "
      "is_vnni) -> Tensor");
