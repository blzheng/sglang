...
TORCH_LIBRARY_FRAGMENT(sgl_kernel, m) {
  ...
  m.def("layernorm_cpu(Tensor(a!) input, Tensor weight, float eps) -> Tensor");
  ...
  m.def("fused_add_layernorm_cpu(Tensor(a!) input, Tensor residual, Tensor weight, float eps) -> Tensor");
