...
std::tuple<bool, int64_t, int64_t, int64_t> get_m_blocking(int64_t M) {
...
struct vnni_traits;
template <>
struct vnni_traits<at::Half> {
  static constexpr int size = 2;
};
template <>
struct vnni_traits<at::BFloat16> {
  static constexpr int size = 2;
};
template <>
struct vnni_traits<at::Float8_e4m3fn> {
  static constexpr int size = 4;
};
template <>
struct vnni_traits<int8_t> {
  static constexpr int size = 4;
};

template <typename T>
constexpr int get_vnni_size() {
  return vnni_traits<T>::size;
}
